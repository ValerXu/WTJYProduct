...
import com.android.jwjy.wtjyproduct.util.DrawableUtils;
import com.android.jwjy.wtjyproduct.util.LogUtil;
...
public class PlayDownLoadActivity extends Activity {
    ...
    private void initEvent() {
        btn_all_select.setOnClickListener(v -> {
    ...
    class DownLoadListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                mHolder.tv_title = convertView.findViewById(R.id.tv_playback_title);
                mHolder.btn_download = convertView.findViewById(R.id.btn_download);
                mHolder.progressBar = convertView.findViewById(R.id.progressBar);
                mHolder.cb_delete = convertView.findViewById(R.id.cb_delete);
                mHolder.tv_duration = convertView.findViewById(R.id.tv_duration);
                mHolder.tv_totalSie = convertView.findViewById(R.id.tv_totalSie);
                mHolder.tv_download_status = convertView.findViewById(R.id.tv_download_status);
                mHolder.btn_play = convertView.findViewById(R.id.btn_play);
                mHolder.ll_status = convertView.findViewById(R.id.ll_status);
                mHolder.iv_shrinkImage = convertView.findViewById(R.id.iv_shringimage);
                mHolder.tv_percent = convertView.findViewById(R.id.tv_percent);
            ...
            mHolder.ll_status.setOnClickListener(v -> {
            ...
            mHolder.cb_delete.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
