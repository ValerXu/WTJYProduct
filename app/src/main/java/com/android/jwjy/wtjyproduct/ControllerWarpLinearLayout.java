 ...
 * 自动换行的LinearLayout
 */
public class ControllerWarpLinearLayout extends ViewGroup {

    private Type mType;
    private List<WarpLine> mWarpLineGroup;

    public ControllerWarpLinearLayout(Context context) {
        this(context, null);
    }

    public ControllerWarpLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.WarpLinearLayoutDefault);
//        super(context, attrs);
    }

    public ControllerWarpLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private final static class Type {
        ...
        Type(Context context, AttributeSet attrs) {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ControllerWarpLinearLayout);
            grivate = typedArray.getInt(R.styleable.ControllerWarpLinearLayout_grivate, grivate);
            horizontal_Space = typedArray.getDimension(R.styleable.ControllerWarpLinearLayout_horizontal_Space, horizontal_Space);
            vertical_Space = typedArray.getDimension(R.styleable.ControllerWarpLinearLayout_vertical_Space, vertical_Space);
            isFull = typedArray.getBoolean(R.styleable.ControllerWarpLinearLayout_isFull, isFull);
        }
    }
