...
public class ModelGroupRecyclerView extends RecyclerView {
    private ModelGroupItemDecoration mItemDecoration;
    ...
    public ModelGroupRecyclerView(Context context) {
        super(context);
    }

    public ModelGroupRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setAdapter(Adapter adapter) {
        if (adapter instanceof ModelGroupRecyclerAdapter) {
    ...
    public void notifyDataSetChanged() {
        mItemDecoration.notifyDataSetChanged((ModelGroupRecyclerAdapter) getAdapter());
    }
