...
public class ModelSwitchButton extends View implements Checkable {
    ...
    public ModelSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ModelSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ModelSwitchButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        }
    ...
    public interface OnCheckedChangeListener{
        void onCheckedChanged(ModelSwitchButton view, boolean isChecked);
    }
