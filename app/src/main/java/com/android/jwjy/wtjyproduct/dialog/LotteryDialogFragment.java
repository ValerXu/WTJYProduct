package com.android.jwjy.wtjyproduct.dialog;
...
import com.android.jwjy.wtjyproduct.adapter.AutoScrollAdapter;
import com.android.jwjy.wtjyproduct.manager.ScrollSpeedLinearLayoutManger;
...
//        cancelImg.setVisibility(View.INVISIBLE);
    ...
    public void performLotteryStop(LotteryResult lotteryResult) {
        ...
        /**
         * 公布或者包含当前用户中奖的情况下 显示中奖人 否则显示谢谢参与
         */
        boolean isPub = lotteryResult.isIncludeCurrentUser() || lotteryResult.isPub();
        textView.setText(isPub ? resultStr : "谢谢参与");
